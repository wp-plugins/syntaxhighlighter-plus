...
dp.sh.HighlightAll = function(name, showGutter /* optional */, showControls /* optional */, collapseAll /* optional */, firstLine /* optional */, showColumns /* optional */)
{
	...
	for(var i = 0; i < elements.length; i++)
	{
		...
		var liArray = highlighter.div.getElementsByTagName("li");
		var addLength = highlighter.div.scrollWidth - 58;
		for (var j = 0; j < liArray.length; j++) {
			var divLine = liArray[j].firstChild;
			divLine.style.width = addLength + "px";
		}
		var divTools = highlighter.div.getElementsByTagName("div");
		divTools[1].style.width = addLength + "px";
	}	
}
